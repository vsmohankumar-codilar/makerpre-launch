    ...
    render() {
        return (
            <div className="pagegrid">
                ...
                <div className="life">
                    <img className="secondimg" src={Lifestyle} alt="lifestyle" />
                </div>
                
                <div className="work">
                    <img className="fourthimg" src={Work} alt="work" />
                </div>
                <div className="passiontext">
                   <h4>Indulge your passions</h4>
                   <p>Your passions shouldn't be just for the weekend. 
                ...
                <div className="financtext">
                    <h4>Gain financial freedom</h4>
                    <p>Start making money work for you. There’s nothing quite like earning 
                        while you sleep.</p>
                </div>
                <div className="passiontext">
                    <h4>Choose your lifestyle</h4>
                    <p>Own your daily schedule. Fancy a lie-in? Go for it! Take 
                        charge of your week.</p>
                </div>
                <div className="financtext">
                    <h4>
                        Work from anywhere
